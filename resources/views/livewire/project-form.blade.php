        ...
        <x-slot name="content">
            ...
            <form class="w-full max-w-sm">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <!-- Street Field -->
                    <div class="w-full px-5 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-client">
                            Client
                        </label>
                        <input wire:model.lazy="client" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-client" name="grid-client" type="text" placeholder="Enter Client">
                    </div>
